...
<body id="{$page.page_name}" class="{$page.body_classes|classnames}">
  ...
  <main>
    ...
    <header id="header" class="ra-header">
      {block name='header'}
...
<div id="header-spacer"></div>
    <section id="wrapper">
      ...
      <div id="Page-Content" class="container ra-container">
        <!-- This contain left column, right column and content-wraper -->
        ...
        {block name="content_wrapper"}
          <div id="content-wrapper" class="js-content-wrapper left-column right-column col-md-4 col-lg-3">
            ...
            {* this is extented in product page *}
            {block name="content"}
