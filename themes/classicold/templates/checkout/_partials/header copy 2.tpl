...
{if $customer.is_logged}
  <a href="{$urls.pages.history}" class="guest-tracking header-nav-link" title="{l s='Order history' d='Shop.Theme.Customeraccount'}">
    {l s='Order history' d='Shop.Theme.Customeraccount'}
  </a>
{else}
  <a href="{$urls.pages.guest_tracking}" class="guest-tracking header-nav-link" title="{l s='Guest Tracking' d='Shop.Theme.Customeraccount'}">
...
<div id="header-favorites-icon"
     class="{if $customer.is_logged}customer-logged-in{else}customer-guest{/if}">
      
<a href="/module/blockwishlist/lists"
{* href="https://rh.rightart.co.uk/module/blockwishlist/lists" *}
   target="{if $customer.is_logged}_self{else}_blank{/if}"
   style="
     position:absolute;
     top:0;
     left:0;
