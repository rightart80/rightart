  ...
  {block name='cart_voucher'}
    <div class="block-promo">
      <div class="cart-voucher js-cart-voucher">
        ...
        <p class="display-promo{if $cart.discounts|count > 0} with-discounts{/if}">
          <a
            ...
            href="#promo-code"
            aria-expanded="{if $cart.discounts|count > 0}true{else}false{/if}"
        ...
        <div id="promo-code" class="collapse{if $cart.discounts|count > 0} in{/if}">
          <div class="promo-code">
            ...
            <a class="collapse-button cancel-promo" role="button" data-toggle="collapse" data-target="#promo-code" aria-expanded="true" aria-controls="promo-code">
