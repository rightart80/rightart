...
<div class="container ra-container" id="header-container">
  <div class="header-box">
        ...
        <div class="header-top">
          ...
          <div id="search-row" class="container">
            ...
            <div class="header-top-right">
              ...
              <div id="header-favorites-icon-full" class="{if $customer.is_logged}customer-logged-in{else}customer-guest{/if}">
   ...
   ">
    ...
    <div class="col-md-2 header-icon-col Sticky-header-icone">
