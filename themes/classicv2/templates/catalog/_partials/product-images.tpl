 ...
 *}
 ...
 <section id="description" class="product-description-box {$piece} {$final_classes} {$art_code}">
   <h2><span id="description-title">About This Artwork</span></h2>

   <p>
     <strong>{$product.name}</strong>
     {hook h='artistlink' product=$product}
     {$product.description|replace:'<p>':''|replace:'</p>':'' nofilter}
   </p>
   <!-- Read More Section -->
   <div id="read-more-container">
     <div id="read-more-content">
       <div id="description-canvas">
         <h3>
           <span id=discription-title>
             Canvas Print Art</span>
         </h3>
         <p>
           {* <strong>{$product.name}</strong>
           {hook h='artistlink' product=$product} *}
           Crafted using premium-quality printing on fine cotton canvas, each artwork is expertly hand-stretched over a
           sturdy wooden frame to create a clean, gallery-style finish. The natural canvas texture adds depth,
           character, and a beautifully refined look that enhances the artwork’s detail.
         </p>

         <p>
           To complete the presentation, each stretched canvas print can be finished with a handcrafted floating frame,
           offered in the same elegant finishes as above, including black or white matte lacquer, natural wood, dark
           walnut, pine wood, charcoal black, chalk white, and gold with a textured metallic finish. Made from
           high-quality wood, these frames showcase fine craftsmanship, rich texture, and beautiful grain patterns for a
           timeless and luxurious statement piece.
         </p>
       ...
       <div id="description-fine-art-paper">
         ...
         <p>
           Crafted on heavyweight, textured fine art paper, each print features a refined white border for an elegant,
           gallery-inspired presentation. For framed selections, premium Acrylite clear-coat plexiglass helps reduce
           glare
           while maintaining exceptional clarity.</p>
         <p>
           Each frame is expertly crafted from quality hardwood and available in sophisticated finishes, including black
           or
           white matte lacquer, natural wood, dark walnut, pine wood, charcoal black, chalk white, and gold with a
           textured
           metallic finish. Designed to highlight fine craftsmanship and the natural beauty of the material, every piece
           brings a timeless, luxurious look to your home.
         </p>
