...
{block name='content'}
  ...
  <div id="product-main" class="product-container">
    <section id="product-images" class="product-images-box">

      {* product large image *}
      <div id="product-large-image" class="large-image">

        {* <section class="canvas square p-01">
          <img class="big-canvas" src="https://i.icanvas.com/SNH209?d=3&sh=s&s=xl&p=1&bg=c&t=1732145651">
        </section> *}
      ...
      <div id="product-thumbnails" class="thumbnails">
        ...
        <section class="canvas square p-01">
          <img class="small-canvas" src="https://i.icanvas.com/SNH209?d=3&sh=s&s=xl&p=1&bg=c&t=1732145651">
        </section>

        {* Room thumbnails *}
        <section class="room room-sqaure position-01 ">
          <div class="room-art-position">
        ...
        <section class="room room-sqaure position-02">
          <div class="room-art-position">
        ...
        <section class="room room-sqaure position-03">
          <div class="room-art-position">
        ...
        <section class="room room-sqaure position-04">
          <div class="room-art-position">
      ...
      {* {block name='page_content_container'}
        <section id="product-large-image" class="large-image">
        ...
        <section id="product-thumbnails" class="thumbnails">
        </section>
    ...
    <section id="product-Options" class="product-Options-box">
