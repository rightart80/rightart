...
<div class="container ra-container" id="header-container">
  <div class="header-box">
    ...
    <div class="col-md-10 header-right-col header-menue-col">
      ...
      {block name='header_nav'}
        <nav class="header-nav">
          <div class="container">
            ...
            <div class="bp-mobile-only text-sm-center mobile">
        ...
        <div class="header-top">
          ...
          <div id="search-row" class="container">
            ...
            <div class="header-top-right">
              ...
              <div id="header-favorites-icon-full"
          ...
          <div class="icone-block-ra">

            <div class="logo-block-ra">
  ...
  <div class="col-md-2 header-icon-col Sticky-header-icone"></div>

  <div id="mobile-header-block"></div>
