...
<style type="text/css">
	...
	#af .filter-group-title .check-all {
	...
	#af .filter-group-item:hover {
		color: #00AFF0;
	}
	#af .filter-group-item.selected {
		color: #00AFF0;
		padding: 7px;
		border-width: 2px;
	}
	#af .filter-group-item.blocked {
		background: #F5F5F5;
		color: #CCC;
		border-color: #DDD;
		cursor: not-allowed;
	...
	#af .available-filters-footer .btn {
		padding-left: 30px;
		padding-right: 30px;
	}
