...
<div id="catalogEI-tab-content-Category" class="catalogEI-tab-content" style="display: none;">
    <form id="import_form_categories" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="categories_import" novalidate="novalidate">
        ...
        <div id="catalogEI-category" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                ...
                <div class="tab-content">
                    <div id="category_configurations" class="tab-pane in active catalogEI_configurations">
                        ...
                        <div id="after_upload_success_alert_categories" class="row after_upload_success_alert hide">
                        ...
                        <div id="after_upload_danger_alert_categories" class="row after_upload_danger_alert hide">
                        ...
                        <div id="import_source_categories" class="form-group import_source">
                            <br>
                        ...
                        <div id="import_type_categories">
                            <br>
                            <div class="file_upload import_type">
                                <div id="file_uploader_categories" class="form-group file_uploader">
                                    <label class="control-label col-lg-3 required">
                                        {l s='Select a file to import' mod='ipcatalogexportimport'}
                                    </label>
                                    <div class="col-lg-4">
                                        <input type="file" name="file" accept=".csv,.txt,.xls,.xlsx,.ods" data-entity="categories" class="entity_file hide">
                                        <div class="dummyfile input-group">
                                            <input class="entity_file-name uploader_input" value="{l s='Choose file' mod='ipcatalogexportimport'}" type="text" name="categories" readonly>
                                    ...
                                    <button type="button" class="btn btn-default show_upload_history" {if $files.categories.data|count == 0}disabled{/if}>
                                    <span class="badge badge-info">{$files.categories.data|count}</span> {l s='Choose from history' mod='ipcatalogexportimport'}
                                    </button>
                                    </div>*}
                                </div>
                            </div>
                            <div id="upload_history_categories" class="panel upload_history import_type hide">
                                <div>
                                    <div class="panel-heading">
                                        {l s='History of uploaded files' mod='ipcatalogexportimport'}
                                        <span class="file_history_nb badge">{$files.categories.data|count}</span>
                                        {*<button type="button" class="btn btn-link pull-right close_history_btn">
                                        <i class="icon-remove"></i>
                                        </button>*}
                                    </div>
                                    {*        <div class="panel-body">*}
                                    <table id="upload_history_table_categories" class="table table-striped table-bordered upload_history_table" data-table="categories">
                                        <thead>
                                            <tr>
                            ...
                            <div class="from_url import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-1">
                                        <button id="file_download_from_url_categories" class="file_download_from_url_btn btn btn-default" data-entity="categories">
                            ...
                            <div class="from_ftp import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="fixed-width-xxl" id="ftp_type_categories" name="ftp_type">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group fixed-width-xxl">
                                            <button id="file_download_from_ftp_categories" class="file_download_from_ftp_btn btn btn-default pull-right" data-entity="categories">
                                                <i class="process-icon-download"></i> {l s='Download' mod='ipcatalogexportimport'}
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <select name="update_by"
                                            class="fixed-width-xxl"
                                            id="category_update_by">
                                        <option value="id">{l s='Category ID' mod='ipcatalogexportimport'}</option>
                                        <option value="name">{l s='Category Name' mod='ipcatalogexportimport'}</option>
                                    </select>
                                    <p class="help-block">
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_old_value" id="category_keep_old_value_yes" value="1" checked="checked" />
                                        <label for="category_keep_old_value_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_old_value" id="category_keep_old_value_no" value="0" />
                                        <label for="category_keep_old_value_no">{l s='No' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="insert_options">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, all the existing categories will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete all existing categories before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="truncate" id="category_truncate_yes" value="1" />
                                        <label for="category_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="truncate" id="category_truncate_no" value="0" checked="checked" />
                                        <label for="category_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='Enable this option to keep your imported categories’ ID number as is. Otherwise, PrestaShop will ignore them and create auto-incremented ID numbers. If this option is enabled and there is a category in your database with this ID, then this category will not be inserted.' mod='ipcatalogexportimport'}"> 
                                        {l s='Keep ID numbers of inserted categories' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_id" id="category_keep_id_yes" value="1" checked="checked" />
                                        <label for="category_keep_id_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_id" id="category_keep_id_no" value="0" />
                                        <label for="category_keep_id_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If a category exists with the imported category name, you can: 1) Ignore the imported row, 2) Create a new category with th existing name.' mod='ipcatalogexportimport'}">
                                        {l s='If a category or a parent category exists with the category name you import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-3">
                                    <select name="name_exists"
                                            class="fixed-width-xxl"
                                            id="category_name_exists">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="convert" id="category_convert_yes" value="1" />
                                    <label for="category_convert_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="convert" id="category_convert_no" value="0" checked="checked" />
                                    <label for="category_convert_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">
                                <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If you enable this option, all type of images of categories will be regenarated.' mod='ipcatalogexportimport'}"> 
                                    {l s='Regenerate thumbnails' mod='ipcatalogexportimport'}
                                </span>
                            </label>
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="regenerate" id="category_regenerate_yes" value="1" checked="checked" />
                                    <label for="category_regenerate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="regenerate" id="category_regenerate_no" value="0" />
                                    <label for="category_regenerate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="send_email" id="category_send_email_yes" value="1" />
                                    <label for="category_send_email_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="send_email" id="category_send_email_no" value="0" checked="checked" />
                                    <label for="category_send_email_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                            ...
                            {foreach from=$shops item=shop}
                                {if $shop.id_shop eq $context_shop}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="category_shops[{$shop.id_shop}]_yes" value="1" checked="checked" />
                                                <label for="category_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="category_shops[{$shop.id_shop}]_no" value="0" />
                                                <label for="category_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                                            </p>
                                ...
                                {else}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="category_shops[{$shop.id_shop}]_yes" value="1" />
                                                <label for="category_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="category_shops[{$shop.id_shop}]_no" value="0" checked="checked" />
                                                <label for="category_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                        ...
                        <div class="panel-footer">
                            <div class="text-right">
                                <button class="btn btn-default next" data-value="category">
                    ...
                    <div id="category_fields" class="tab-pane catalogEI_fields catalogEI_category_fields">
                        <div id="container-customer" class="panel">
                            ...
                            <div class="alert alert-info">
                                ...
                                <p><strong style="color:red">{l s='Important!' mod='ipcatalogexportimport'}</strong> {l s='If a category exists with the imported ID, it will be updated, otherwise a new category will be created. So, if you want to only create new categories while there are existing ones with the imported IDs, you must ignore the ID column below. Note that "If a category exists with the imported category name" condition has priority!' mod='ipcatalogexportimport'}</p>
                            </div>
                            <div id="error_duplicate_type_categories" class="alert alert-danger" style="display:none;">
                                {l s='Two columns cannot have the same value' mod='ipcatalogexportimport'}:
                                <strong></strong>
                            </div>
                            <div id="required_column_categories" class="alert alert-danger" style="display:none;">
                                {l s='This column must be set:' mod='ipcatalogexportimport'} <span id="missing_column_categories">&nbsp;</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-5">
                                    <label class="control-label" for="category_skip">
                                    ...
                                    &nbsp;
                                    <input class="fixed-width-md" type="text" name="skip" id="category_skip" value="1" />
                                </div>
                            ...
                            <div id="view_data_categories" class="form-group catalogEI_view_data">
                                <div class="col-lg-12">
                                    {*{section name=nb_i start=0 loop=$nb_table step=1}
                                    {assign var=i value=$smarty.section.nb_i.index}
                                    {$data.$i}
                                    {/section}*}
                                    <div id="view_data_table_categories" class="catalogEI_view_data_table">
                                        {$columns.categories}
                                    </div>
                                    <div class="text-center paginate categories">
                                        <button id="btn_left_categories" type="button" class="btn btn-default go_left" disabled="disabled" data-entity="categories">
                                            <i class="icon-angle-left"></i>
                                        </button>
                                        <button id="btn_categories_page_1" type="button" class="btn btn-default activated btn_page" data-entity="categories">1</button>
                                        <span class="dynamic_buttons">
                                            {if $paginator.categories.nbTable > 7}
                                                <span id="btn_categories_left_dots" class="hide">...</span>
                                                {for $foo=2 to $paginator.categories.nbTable - 1}
                                                    <button id="btn_categories_page_{$foo}" type="button" class="btn btn-default btn_hideable btn_page{if $foo > 5} hide{/if}" data-entity="categories">{$foo}</button>
                                                {/for}
                                                <span id="btn_categories_right_dots">...</span>
                                                <button id="btn_categories_page_{$paginator.categories.nbTable}" type="button" class="btn btn-default btn_page" data-entity="categories">{$paginator.categories.nbTable}</button>
                                            {else}
                                                {for $foo=2 to $paginator.categories.nbTable}
                                                    <button id="btn_categories_page_{$foo}" type="button" class="btn btn-default btn_page" data-entity="categories">{$foo}</button>
                                                {/for}
                                            {/if}
                                        </span>
                                        <button id="btn_right_categories" type="button" class="btn btn-default go_right"{if $paginator.categories.nbTable == 1} disabled="disabled"{/if} data-entity="categories">
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-default back" data-value="category">
                                <i class="process-icon-back"></i>{l s='Back' mod='ipcatalogexportimport'}
                            </button>
                            <button class="btn btn-default pull-right" type="submit" value="1" name="import_categories" disabled>
