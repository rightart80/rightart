...
<div id="catalogEI-tab-content-Feature" class="catalogEI-tab-content" style="display: none;">
    <form id="import_form_features" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="features_import" novalidate="novalidate">
        <input type="hidden" name="entity" value="features" />
        <input type="hidden" name="filename" value="" />
        <input type="hidden" name="id_employee" value="{$id_employee}" />
        <div id="catalogEI-feature" class="panel catalogEI-tab">
            <h3 class="tab"><i class="icon-th"></i> {l s='Features' mod='ipcatalogexportimport'}</h3>
            <div class="form-wrapper">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#feature_configurations">
                            <i class="icon-wrench"></i>
                            {l s='Configurations' mod='ipcatalogexportimport'}</a>
                    </li>
                    <li><a data-toggle="tab" href="#feature_fields">
                            <i class="icon-sliders"></i>
                            {l s='Fields' mod='ipcatalogexportimport'}</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div id="feature_configurations" class="tab-pane in active catalogEI_configurations">
                        ...
                        <div id="after_upload_success_alert_features" class="row after_upload_success_alert hide">
                        ...
                        <div id="after_upload_danger_alert_features" class="row after_upload_danger_alert hide">
                        ...
                        <div id="import_source_features" class="form-group import_source">
                            <br>
                        ...
                        <div id="import_type_features">
                            <br>
                            <div class="file_upload import_type">
                                <div id="file_uploader_features" class="form-group file_uploader">
                                    <label class="control-label col-lg-3 required">
                                        {l s='Select a file to import' mod='ipcatalogexportimport'}
                                    </label>
                                    <div class="col-lg-4">
                                        <input type="file" name="file" accept=".csv,.txt,.xls,.xlsx,.ods" data-entity="features" class="entity_file hide">
                                        <div class="dummyfile input-group">
                                            <input class="entity_file-name uploader_input" value="{l s='Choose file' mod='ipcatalogexportimport'}" type="text" name="features" readonly>
                                    ...
                                    <button type="button" class="btn btn-default show_upload_history" {if $files.features.data|count == 0}disabled{/if}>
                                    <span class="badge badge-info">{$files.features.data|count}</span> {l s='Choose from history' mod='ipcatalogexportimport'}
                                    </button>
                                    </div>*}
                                </div>
                            </div>
                            <div id="upload_history_features" class="panel upload_history import_type hide">
                                <div>
                                    <div class="panel-heading">
                                        {l s='History of uploaded files' mod='ipcatalogexportimport'}
                                        <span class="file_history_nb badge">{$files.features.data|count}</span>
                                        {*<button type="button" class="btn btn-link pull-right close_history_btn">
                                        <i class="icon-remove"></i>
                                        </button>*}
                                    </div>
                                    {*        <div class="panel-body">*}
                                    <table id="upload_history_table_features" class="table table-striped table-bordered upload_history_table" data-table="features">
                                        <thead>
                                            <tr>
                            ...
                            <div class="from_url import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-1">
                                        <button id="file_download_from_url_features" class="file_download_from_url_btn btn btn-default" data-entity="features">
                            ...
                            <div class="from_ftp import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="fixed-width-xxl" id="ftp_type_features" name="ftp_type">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group fixed-width-xxl">
                                            <button id="file_download_from_ftp_features" class="file_download_from_ftp_btn btn btn-default pull-right" data-entity="features">
                                                <i class="process-icon-download"></i> {l s='Download' mod='ipcatalogexportimport'}
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text"
                                       ...
                                       id="feature_multivalue_separator"
                                       value=","
                                       class="fixed-width-xxl"
                                       size="33"	
                                       required="required" />
                        ...
                        <div class="update_options hide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <select name="update_by"
                                            class="fixed-width-xxl"
                                            id="feature_update_by">
                                        <option value="id">{l s='Feature ID' mod='ipcatalogexportimport'}</option>
                                        <option value="name">{l s='Feature Name' mod='ipcatalogexportimport'}</option>
                                    </select>
                                    <p class="help-block">
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, the existing feature values (not features themselves) of the imported features will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete existing feature values of imported features before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="value_truncate" id="feature_value_truncate_yes" value="1" />
                                        <label for="feature_value_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="value_truncate" id="feature_value_truncate_no" value="0" checked="checked" />
                                        <label for="feature_value_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_old_value" id="feature_keep_old_value_yes" value="1" checked="checked" />
                                        <label for="feature_keep_old_value_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_old_value" id="feature_keep_old_value_no" value="0" />
                                        <label for="feature_keep_old_value_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                        ...
                        <div class="insert_options">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, all the existing features will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete all existing features before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="truncate" id="feature_truncate_yes" value="1" />
                                        <label for="feature_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="truncate" id="feature_truncate_no" value="0" checked="checked" />
                                        <label for="feature_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='Enable this option to keep your imported features’ ID number as is. Otherwise, PrestaShop will ignore them and create auto-incremented ID numbers. If this option is enabled and there is a feature in your database with this ID, then this feature will not be inserted.' mod='ipcatalogexportimport'}"> 
                                        {l s='Keep ID numbers of inserted features' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_id" id="feature_keep_id_yes" value="1" checked="checked" />
                                        <label for="feature_keep_id_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_id" id="feature_keep_id_no" value="0" />
                                        <label for="feature_keep_id_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If a feature exists with the imported feature name, you can: 1) Ignore the imported row, 2) Create a new feature with the existing name.' mod='ipcatalogexportimport'}">
                                        {l s='If a feature exists with the feature name you import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-3">
                                    <select name="name_exists"
                                            class="fixed-width-xxl"
                                            id="feature_name_exists">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="convert" id="feature_convert_yes" value="1" />
                                    <label for="feature_convert_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="convert" id="feature_convert_no" value="0" checked="checked" />
                                    <label for="feature_convert_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="send_email" id="feature_send_email_yes" value="1" />
                                    <label for="feature_send_email_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="send_email" id="feature_send_email_no" value="0" checked="checked" />
                                    <label for="feature_send_email_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                            ...
                            {foreach from=$shops item=shop}
                                {if $shop.id_shop eq $context_shop}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="feature_shops[{$shop.id_shop}]_yes" value="1" checked="checked" />
                                                <label for="feature_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="feature_shops[{$shop.id_shop}]_no" value="0" />
                                                <label for="feature_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                                            </p>
                                ...
                                {else}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="feature_shops[{$shop.id_shop}]_yes" value="1" />
                                                <label for="feature_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="feature_shops[{$shop.id_shop}]_no" value="0" checked="checked" />
                                                <label for="feature_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                        ...
                        <div class="panel-footer">
                            <div class="text-right">
                                <button class="btn btn-default next" data-value="feature">
                                    <i class="process-icon-next"></i>{l s='Next' mod='ipcatalogexportimport'}
                                </button>
                            </div>
                        </div>
                    </div>
                    <div id="feature_fields" class="tab-pane catalogEI_fields catalogEI_feature_fields">
                        <div id="container-feature" class="panel">
                            ...
                            <div class="alert alert-info">
                                ...
                                <p><strong style="color:red">{l s='Important!' mod='ipcatalogexportimport'}</strong> {l s='The features that exist with the imported names will always be updated. Otherwise: if a feature exists with the imported ID, it will be updated, otherwise a new feature will be created. So, if you want to only create new features while there are existing ones with the imported IDs, you must ignore the ID column below.' mod='ipcatalogexportimport'}</p>
                                <p>{l s='If New Password is set, the password of the existing feature will be updated to it, otherwise the encrypted password for the existing feature must be set! For new features New Password must always be set!' mod='ipcatalogexportimport'}</p>
                            </div>
                            <div id="error_duplicate_type_features" class="alert alert-danger" style="display:none;">
                                {l s='Two columns cannot have the same value' mod='ipcatalogexportimport'}:
                                <strong></strong>
                            </div>
                            <div id="required_column_features" class="alert alert-danger" style="display:none;">
                                {l s='This column must be set:' mod='ipcatalogexportimport'} <span id="missing_column_features">&nbsp;</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-5">
                                    <label class="control-label" for="feature_skip">
                                    ...
                                    &nbsp;
                                    <input class="fixed-width-md" type="text" name="skip" id="feature_skip" value="1" />
                                </div>
                            ...
                            <div id="view_data_features" class="form-group catalogEI_view_data">
                                <div class="col-lg-12">
                                    {*{section name=nb_i start=0 loop=$nb_table step=1}
                                    {assign var=i value=$smarty.section.nb_i.index}
                                    {$data.$i}
                                    {/section}*}
                                    <div id="view_data_table_features" class="catalogEI_view_data_table">
                                        {$columns.features}
                                    </div>
                                    <div class="text-center paginate features">
                                        <button id="btn_left_features" type="button" class="btn btn-default go_left" disabled="disabled" data-entity="features">
                                            <i class="icon-angle-left"></i>
                                        </button>
                                        <button id="btn_features_page_1" type="button" class="btn btn-default activated btn_page" data-entity="features">1</button>
                                        <span class="dynamic_buttons">
                                            {if $paginator.features.nbTable > 7}
                                                <span id="btn_features_left_dots" class="hide">...</span>
                                                {for $foo=2 to $paginator.features.nbTable - 1}
                                                    <button id="btn_features_page_{$foo}" type="button" class="btn btn-default btn_hideable btn_page{if $foo > 5} hide{/if}" data-entity="features">{$foo}</button>
                                                {/for}
                                                <span id="btn_features_right_dots">...</span>
                                                <button id="btn_features_page_{$paginator.features.nbTable}" type="button" class="btn btn-default btn_page" data-entity="features">{$paginator.features.nbTable}</button>
                                            {else}
                                                {for $foo=2 to $paginator.features.nbTable}
                                                    <button id="btn_features_page_{$foo}" type="button" class="btn btn-default btn_page" data-entity="features">{$foo}</button>
                                                {/for}
                                            {/if}
                                        </span>
                                        <button id="btn_right_features" type="button" class="btn btn-default go_right"{if $paginator.features.nbTable == 1} disabled="disabled"{/if} data-entity="features">
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-default back" data-value="feature">
                                <i class="process-icon-back"></i>{l s='Back' mod='ipcatalogexportimport'}
                            </button>
                            <button class="btn btn-default pull-right" type="submit" value="1" name="import_features" disabled>
