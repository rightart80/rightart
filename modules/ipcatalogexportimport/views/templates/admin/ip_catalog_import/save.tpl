...
<div id="catalogEI-tab-content-Save" class="catalogEI-tab-content" style="display: none;">
    <div id="catalogEI-save" class="panel catalogEI-tab form-horizontal catalogEI_save">
        ...
        <div class="row">
                ...
                <ul id="configs" class="list-group">
                    {foreach from=$configs item=config}
                        {if $config.name == 'catalog_default'}
                            <li data-id="{$config.id_ipcatalogimport}"
                                data-config='{$config.configuration}'
                                class="list-group-item"><b>-- {l s='Default' mod='ipcatalogexportimport'} --</b>
                                <span class="pull-right apply_span default_config">
                                    ...
                                    <a class="btn btn-default" href="{$ajax_url}&action=getSetting&st_id={$config.id_ipcatalogimport}">
                                        <i class="icon-download"></i></a>
                                </span>
                            </li>
                        {else}
                            <li data-id="{$config.id_ipcatalogimport}" data-config='{$config.configuration}'
                                class="list-group-item"><b>{$config.name}</b>
            ...
            <div id="txt_file_uploader" class="col-md-6">
