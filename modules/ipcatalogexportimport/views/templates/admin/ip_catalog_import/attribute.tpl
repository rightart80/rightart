...
<div id="catalogEI-tab-content-Attribute" class="catalogEI-tab-content" style="display: none;">
    <form id="import_form_attributes" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="attributes_import" novalidate="novalidate">
        <input type="hidden" name="entity" value="attributes" />
        ...
        <div id="catalogEI-attribute" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                ...
                <div class="tab-content">
                    <div id="attribute_configurations" class="tab-pane in active catalogEI_configurations">
                        <div class="alert alert-info alert-dismissible fade in">
                            ...
                            <ul>
                                ...
                                <li>{l s='If you import to a new empty shop, the import order must be: Manufacturers > Suppliers > Groups > Customers > Addresses > Carriers > Warehouses > Categories > Attributes > Attributes > Products > Combinations > Packs > Discounts' mod='ipcatalogexportimport'}</li>
                            </ul>
                        </div>
                        <div id="after_upload_success_alert_attributes" class="row after_upload_success_alert hide">
                        ...
                        <div id="after_upload_danger_alert_attributes" class="row after_upload_danger_alert hide">
                        ...
                        <div id="import_source_attributes" class="form-group import_source">
                            <br>
                        ...
                        <div id="import_type_attributes">
                            <br>
                            <div class="file_upload import_type">
                                <div id="file_uploader_attributes" class="form-group file_uploader">
                                    <label class="control-label col-lg-3 required">
                                        {l s='Select a file to import' mod='ipcatalogexportimport'}
                                    </label>
                                    <div class="col-lg-4">
                                        <input type="file" name="file" accept=".csv,.txt,.xls,.xlsx,.ods" data-entity="attributes" class="entity_file hide">
                                        <div class="dummyfile input-group">
                                            <input class="entity_file-name uploader_input" value="{l s='Choose file' mod='ipcatalogexportimport'}" type="text" name="attributes" readonly>
                                    ...
                                    <button type="button" class="btn btn-default show_upload_history" {if $files.attributes.data|count == 0}disabled{/if}>
                                    <span class="badge badge-info">{$files.attributes.data|count}</span> {l s='Choose from history' mod='ipcatalogexportimport'}
                                    </button>
                                    </div>*}
                                </div>
                            </div>
                            <div id="upload_history_attributes" class="panel upload_history import_type hide">
                                <div>
                                    <div class="panel-heading">
                                        {l s='History of uploaded files' mod='ipcatalogexportimport'}
                                        <span class="file_history_nb badge">{$files.attributes.data|count}</span>
                                        {*<button type="button" class="btn btn-link pull-right close_history_btn">
                                        <i class="icon-remove"></i>
                                        </button>*}
                                    </div>
                                    {*        <div class="panel-body">*}
                                    <table id="upload_history_table_attributes" class="table table-striped table-bordered upload_history_table" data-table="attributes">
                                        <thead>
                                            <tr>
                            ...
                            <div class="from_url import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-1">
                                        <button id="file_download_from_url_attributes" class="file_download_from_url_btn btn btn-default" data-entity="attributes">
                            ...
                            <div class="from_ftp import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="fixed-width-xxl" id="ftp_type_attributes" name="ftp_type">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group fixed-width-xxl">
                                            <button id="file_download_from_ftp_attributes" class="file_download_from_ftp_btn btn btn-default pull-right" data-entity="attributes">
                                                <i class="process-icon-download"></i> {l s='Download' mod='ipcatalogexportimport'}
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="update_options hide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <select name="update_by"
                                            class="fixed-width-xxl"
                                            id="attribute_update_by">
                                        <option value="id">{l s='Attribute ID' mod='ipcatalogexportimport'}</option>
                                        <option value="name">{l s='Attribute Name' mod='ipcatalogexportimport'}</option>
                                    </select>
                                    <p class="help-block">
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, the existing attribute values (not attribute groups) of the imported attributes will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete existing attribute values of imported attribute groups before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="value_truncate" id="attribute_value_truncate_yes" value="1" />
                                        <label for="attribute_value_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="value_truncate" id="attribute_value_truncate_no" value="0" checked="checked" />
                                        <label for="attribute_value_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_old_value" id="attribute_keep_old_value_yes" value="1" checked="checked" />
                                        <label for="attribute_keep_old_value_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_old_value" id="attribute_keep_old_value_no" value="0" />
                                        <label for="attribute_keep_old_value_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                        ...
                        <div class="insert_options">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, all the existing attributes will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete all existing attributes before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="truncate" id="attribute_truncate_yes" value="1" />
                                        <label for="attribute_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="truncate" id="attribute_truncate_no" value="0" checked="checked" />
                                        <label for="attribute_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='Enable this option to keep your imported attributes’ ID number as is. Otherwise, PrestaShop will ignore them and create auto-incremented ID numbers. If this option is enabled and there is an attribute in your database with this ID, then this attribute will not be inserted.' mod='ipcatalogexportimport'}"> 
                                        {l s='Keep ID numbers of inserted attributes' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_id" id="attribute_keep_id_yes" value="1" checked="checked" />
                                        <label for="attribute_keep_id_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_id" id="attribute_keep_id_no" value="0" />
                                        <label for="attribute_keep_id_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If an attribute exists with the imported attribute name, you can: 1) Ignore the imported row, 2) Create a new attribute with the existing name.' mod='ipcatalogexportimport'}">
                                        {l s='If an attribute exists with the attribute name you import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-3">
                                    <select name="name_exists"
                                            class="fixed-width-xxl"
                                            id="attribute_name_exists">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="convert" id="attribute_convert_yes" value="1" />
                                    <label for="attribute_convert_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="convert" id="attribute_convert_no" value="0" checked="checked" />
                                    <label for="attribute_convert_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="send_email" id="attribute_send_email_yes" value="1" />
                                    <label for="attribute_send_email_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="send_email" id="attribute_send_email_no" value="0" checked="checked" />
                                    <label for="attribute_send_email_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                            ...
                            {foreach from=$shops item=shop}
                                {if $shop.id_shop eq $context_shop}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="attribute_shops[{$shop.id_shop}]_yes" value="1" checked="checked" />
                                                <label for="attribute_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="attribute_shops[{$shop.id_shop}]_no" value="0" />
                                                <label for="attribute_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                                            </p>
                                ...
                                {else}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="attribute_shops[{$shop.id_shop}]_yes" value="1" />
                                                <label for="attribute_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="attribute_shops[{$shop.id_shop}]_no" value="0" checked="checked" />
                                                <label for="attribute_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                        ...
                        <div class="panel-footer">
                            <div class="text-right">
                                <button class="btn btn-default next" data-value="attribute">
                    ...
                    <div id="attribute_fields" class="tab-pane catalogEI_fields catalogEI_attribute_fields">
                        <div id="container-attribute" class="panel">
                            ...
                            <div class="alert alert-info">
                                ...
                                <p><strong style="color:red">{l s='Important!' mod='ipcatalogexportimport'}</strong> {l s='The attributes that exist with the imported names will always be updated. Otherwise: if an attribute exists with the imported ID, it will be updated, otherwise a new attribute will be created. So, if you want to only create new attributes while there are existing ones with the imported IDs, you must ignore the ID column below.' mod='ipcatalogexportimport'}</p>
                                <p>{l s='If New Password is set, the password of the existing attribute will be updated to it, otherwise the encrypted password for the existing attribute must be set! For new attributes New Password must always be set!' mod='ipcatalogexportimport'}</p>
                            </div>
                            <div id="error_duplicate_type_attributes" class="alert alert-danger" style="display:none;">
                                {l s='Two columns cannot have the same value' mod='ipcatalogexportimport'}:
                                <strong></strong>
                            </div>
                            <div id="required_column_attributes" class="alert alert-danger" style="display:none;">
                                {l s='This column must be set:' mod='ipcatalogexportimport'} <span id="missing_column_attributes">&nbsp;</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-5">
                                    <label class="control-label" for="attribute_skip">
                                    ...
                                    &nbsp;
                                    <input class="fixed-width-md" type="text" name="skip" id="attribute_skip" value="1" />
                                </div>
                            ...
                            <div id="view_data_attributes" class="form-group catalogEI_view_data">
                                <div class="col-lg-12">
                                    {*{section name=nb_i start=0 loop=$nb_table step=1}
                                    {assign var=i value=$smarty.section.nb_i.index}
                                    {$data.$i}
                                    {/section}*}
                                    <div id="view_data_table_attributes" class="catalogEI_view_data_table">
                                        {$columns.attributes}
                                    </div>
                                    <div class="text-center paginate attributes">
                                        <button id="btn_left_attributes" type="button" class="btn btn-default go_left" disabled="disabled" data-entity="attributes">
                                            <i class="icon-angle-left"></i>
                                        </button>
                                        <button id="btn_attributes_page_1" type="button" class="btn btn-default activated btn_page" data-entity="attributes">1</button>
                                        <span class="dynamic_buttons">
                                            {if $paginator.attributes.nbTable > 7}
                                                <span id="btn_attributes_left_dots" class="hide">...</span>
                                                {for $foo=2 to $paginator.attributes.nbTable - 1}
                                                    <button id="btn_attributes_page_{$foo}" type="button" class="btn btn-default btn_hideable btn_page{if $foo > 5} hide{/if}" data-entity="attributes">{$foo}</button>
                                                {/for}
                                                <span id="btn_attributes_right_dots">...</span>
                                                <button id="btn_attributes_page_{$paginator.attributes.nbTable}" type="button" class="btn btn-default btn_page" data-entity="attributes">{$paginator.attributes.nbTable}</button>
                                            {else}
                                                {for $foo=2 to $paginator.attributes.nbTable}
                                                    <button id="btn_attributes_page_{$foo}" type="button" class="btn btn-default btn_page" data-entity="attributes">{$foo}</button>
                                                {/for}
                                            {/if}
                                        </span>
                                        <button id="btn_right_attributes" type="button" class="btn btn-default go_right"{if $paginator.attributes.nbTable == 1} disabled="disabled"{/if} data-entity="attributes">
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-default back" data-value="attribute">
                                <i class="process-icon-back"></i>{l s='Back' mod='ipcatalogexportimport'}
                            </button>
                            <button class="btn btn-default pull-right" type="submit" value="1" name="import_attributes" disabled>
