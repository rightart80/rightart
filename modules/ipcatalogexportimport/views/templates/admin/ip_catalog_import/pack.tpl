...
<div id="catalogEI-tab-content-Pack" class="catalogEI-tab-content" style="display: none;">
    <form id="import_form_packs" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="packs_import" novalidate="novalidate">
        <input type="hidden" name="entity" value="packs" />
        ...
        <div id="catalogEI-pack" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                ...
                <div class="tab-content">
                    <div id="pack_configurations" class="tab-pane in active catalogEI_configurations">
                        ...
                        <div id="after_upload_success_alert_packs" class="row after_upload_success_alert hide">
                        ...
                        <div id="after_upload_danger_alert_packs" class="row after_upload_danger_alert hide">
                        ...
                        <div id="import_source_packs" class="form-group import_source">
                            <br>
                        ...
                        <div id="import_type_packs">
                            <br>
                            <div class="file_upload import_type">
                                <div id="file_uploader_packs" class="form-group file_uploader">
                                    <label class="control-label col-lg-3 required">
                                        {l s='Select a file to import' mod='ipcatalogexportimport'}
                                    </label>
                                    <div class="col-lg-4">
                                        <input type="file" name="file" accept=".csv,.txt,.xls,.xlsx,.ods" data-entity="packs" class="entity_file hide">
                                        <div class="dummyfile input-group">
                                            <input class="entity_file-name uploader_input" value="{l s='Choose file' mod='ipcatalogexportimport'}" type="text" name="packs" readonly>
                                    ...
                                    <button type="button" class="btn btn-default show_upload_history" {if $files.packs.data|count == 0}disabled{/if}>
                                    <span class="badge badge-info">{$files.packs.data|count}</span> {l s='Choose from history' mod='ipcatalogexportimport'}
                                    </button>
                                    </div>*}
                                </div>
                            </div>
                            <div id="upload_history_packs" class="panel upload_history import_type hide">
                                <div>
                                    <div class="panel-heading">
                                        {l s='History of uploaded files' mod='ipcatalogexportimport'}
                                        <span class="file_history_nb badge">{$files.packs.data|count}</span>
                                        {*<button type="button" class="btn btn-link pull-right close_history_btn">
                                        <i class="icon-remove"></i>
                                        </button>*}
                                    </div>
                                    {*        <div class="panel-body">*}
                                    <table id="upload_history_table_packs" class="table table-striped table-bordered upload_history_table" data-table="packs">
                                        <thead>
                                            <tr>
                            ...
                            <div class="from_url import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-1">
                                        <button id="file_download_from_url_packs" class="file_download_from_url_btn btn btn-default" data-entity="packs">
                            ...
                            <div class="from_ftp import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="fixed-width-xxl" id="ftp_type_packs" name="ftp_type">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group fixed-width-xxl">
                                            <button id="file_download_from_ftp_packs" class="file_download_from_ftp_btn btn btn-default pull-right" data-entity="packs">
                                                <i class="process-icon-download"></i> {l s='Download' mod='ipcatalogexportimport'}
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="update_options hide">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, when the updated new value is empty, the old value will not be updated. Otherwise, it will be updated to empty value if the new value is empty. Note that only the quantites can be updated!' mod='ipcatalogexportimport'}">
                                        {l s='Keep the old value if the new value is empty' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_old_value" id="pack_keep_old_value_yes" value="1" checked="checked" />
                                        <label for="pack_keep_old_value_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_old_value" id="pack_keep_old_value_no" value="0" />
                                        <label for="pack_keep_old_value_no">{l s='No' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="insert_options">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, all the existing packs will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete all existing packs before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="truncate" id="pack_truncate_yes" value="1" />
                                        <label for="pack_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="truncate" id="pack_truncate_no" value="0" checked="checked" />
                                        <label for="pack_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, all the existing packs will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete other products from the packs you import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="delete_others" id="pack_delete_others_yes" value="1" />
                                        <label for="pack_delete_others_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="delete_others" id="pack_delete_others_no" value="0" checked="checked" />
                                        <label for="pack_delete_others_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="convert" id="pack_convert_yes" value="1" />
                                    <label for="pack_convert_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="convert" id="pack_convert_no" value="0" checked="checked" />
                                    <label for="pack_convert_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="send_email" id="pack_send_email_yes" value="1" />
                                    <label for="pack_send_email_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="send_email" id="pack_send_email_no" value="0" checked="checked" />
                                    <label for="pack_send_email_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                            ...
                            {foreach from=$shops item=shop}
                                {if $shop.id_shop eq $context_shop}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="pack_shops[{$shop.id_shop}]_yes" value="1" checked="checked" />
                                                <label for="pack_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="pack_shops[{$shop.id_shop}]_no" value="0" />
                                                <label for="pack_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                                            </p>
                                ...
                                {else}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="pack_shops[{$shop.id_shop}]_yes" value="1" />
                                                <label for="pack_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="pack_shops[{$shop.id_shop}]_no" value="0" checked="checked" />
                                                <label for="pack_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                        ...
                        <div class="panel-footer">
                            <div class="text-right">
                                <button class="btn btn-default next" data-value="pack">
                    ...
                    <div id="pack_fields" class="tab-pane catalogEI_fields catalogEI_pack_fields">
                        <div id="container-customer" class="panel">
                            ...
                            <div id="error_duplicate_type_packs" class="alert alert-danger" style="display:none;">
                                {l s='Two columns cannot have the same value' mod='ipcatalogexportimport'}:
                                <strong></strong>
                            </div>
                            <div id="required_column_packs" class="alert alert-danger" style="display:none;">
                                {l s='This column must be set:' mod='ipcatalogexportimport'} <span id="missing_column_packs">&nbsp;</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-5">
                                    <label class="control-label" for="pack_skip">
                                    ...
                                    &nbsp;
                                    <input class="fixed-width-md" type="text" name="skip" id="pack_skip" value="1" />
                                </div>
                            ...
                            <div id="view_data_packs" class="form-group catalogEI_view_data">
                                <div class="col-lg-12">
                                    {*{section name=nb_i start=0 loop=$nb_table step=1}
                                    {assign var=i value=$smarty.section.nb_i.index}
                                    {$data.$i}
                                    {/section}*}
                                    <div id="view_data_table_packs" class="catalogEI_view_data_table">
                                        {$columns.packs}
                                    </div>
                                    <div class="text-center paginate packs">
                                        <button id="btn_left_packs" type="button" class="btn btn-default go_left" disabled="disabled" data-entity="packs">
                                            <i class="icon-angle-left"></i>
                                        </button>
                                        <button id="btn_packs_page_1" type="button" class="btn btn-default activated btn_page" data-entity="packs">1</button>
                                        <span class="dynamic_buttons">
                                            {if $paginator.packs.nbTable > 7}
                                                <span id="btn_packs_left_dots" class="hide">...</span>
                                                {for $foo=2 to $paginator.packs.nbTable - 1}
                                                    <button id="btn_packs_page_{$foo}" type="button" class="btn btn-default btn_hideable btn_page{if $foo > 5} hide{/if}" data-entity="packs">{$foo}</button>
                                                {/for}
                                                <span id="btn_packs_right_dots">...</span>
                                                <button id="btn_packs_page_{$paginator.packs.nbTable}" type="button" class="btn btn-default btn_page" data-entity="packs">{$paginator.packs.nbTable}</button>
                                            {else}
                                                {for $foo=2 to $paginator.packs.nbTable}
                                                    <button id="btn_packs_page_{$foo}" type="button" class="btn btn-default btn_page" data-entity="packs">{$foo}</button>
                                                {/for}
                                            {/if}
                                        </span>
                                        <button id="btn_right_packs" type="button" class="btn btn-default go_right"{if $paginator.packs.nbTable == 1} disabled="disabled"{/if} data-entity="packs">
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-default back" data-value="pack">
                                <i class="process-icon-back"></i>{l s='Back' mod='ipcatalogexportimport'}
                            </button>
                            <button class="btn btn-default pull-right" type="submit" value="1" name="import_packs" disabled>
