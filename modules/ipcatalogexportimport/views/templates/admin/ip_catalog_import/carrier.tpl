...
<div id="catalogEI-tab-content-Carrier" class="catalogEI-tab-content" style="display: none;">
    <form id="import_form_carriers" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="carriers_import" novalidate="novalidate">
        <input type="hidden" name="entity" value="carriers" />
        ...
        <div id="catalogEI-carrier" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                ...
                <div class="tab-content">
                    <div id="carrier_configurations" class="tab-pane in active catalogEI_configurations">
                        ...
                        <div id="after_upload_success_alert_carriers" class="row after_upload_success_alert hide">
                        ...
                        <div id="after_upload_danger_alert_carriers" class="row after_upload_danger_alert hide">
                        ...
                        <div id="import_source_carriers" class="form-group import_source">
                            <br>
                        ...
                        <div id="import_type_carriers">
                            <br>
                            <div class="file_upload import_type">
                                <div id="file_uploader_carriers" class="form-group file_uploader">
                                    <label class="control-label col-lg-3 required">
                                        {l s='Select a file to import' mod='ipcatalogexportimport'}
                                    </label>
                                    <div class="col-lg-4">
                                        <input type="file" name="file" accept=".csv,.txt,.xls,.xlsx,.ods" data-entity="carriers" class="entity_file hide">
                                        <div class="dummyfile input-group">
                                            <input class="entity_file-name uploader_input" value="{l s='Choose file' mod='ipcatalogexportimport'}" type="text" name="carriers" readonly>
                                    ...
                                    <button type="button" class="btn btn-default show_upload_history" {if $files.carriers.data|count == 0}disabled{/if}>
                                    <span class="badge badge-info">{$files.carriers.data|count}</span> {l s='Choose from history' mod='ipcatalogexportimport'}
                                    </button>
                                    </div>*}
                                </div>
                            </div>
                            <div id="upload_history_carriers" class="panel upload_history import_type hide">
                                <div>
                                    <div class="panel-heading">
                                        {l s='History of uploaded files' mod='ipcatalogexportimport'}
                                        <span class="file_history_nb badge">{$files.carriers.data|count}</span>
                                        {*<button type="button" class="btn btn-link pull-right close_history_btn">
                                        <i class="icon-remove"></i>
                                        </button>*}
                                    </div>
                                    {*        <div class="panel-body">*}
                                    <table id="upload_history_table_carriers" class="table table-striped table-bordered upload_history_table" data-table="carriers">
                                        <thead>
                                            <tr>
                            ...
                            <div class="from_url import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-1">
                                        <button id="file_download_from_url_carriers" class="file_download_from_url_btn btn btn-default" data-entity="carriers">
                            ...
                            <div class="from_ftp import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="fixed-width-xxl" id="ftp_type_carriers" name="ftp_type">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group fixed-width-xxl">
                                            <button id="file_download_from_ftp_carriers" class="file_download_from_ftp_btn btn btn-default pull-right" data-entity="carriers">
                                                <i class="process-icon-download"></i> {l s='Download' mod='ipcatalogexportimport'}
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <select name="update_by"
                                            class="fixed-width-xxl"
                                            id="carrier_update_by">
                                        <option value="reference">{l s='Reference ID' mod='ipcatalogexportimport'}</option>
                                        <option value="id">{l s='Carrier ID' mod='ipcatalogexportimport'}</option>
                                        <option value="name">{l s='Carrier Name' mod='ipcatalogexportimport'}</option>
                                    </select>
                                    <p class="help-block">
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_old_value" id="carrier_keep_old_value_yes" value="1" checked="checked" />
                                        <label for="carrier_keep_old_value_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_old_value" id="carrier_keep_old_value_no" value="0" />
                                        <label for="carrier_keep_old_value_no">{l s='No' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="insert_options">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, all the existing carriers will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete all existing carriers before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="truncate" id="carrier_truncate_yes" value="1" />
                                        <label for="carrier_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="truncate" id="carrier_truncate_no" value="0" checked="checked" />
                                        <label for="carrier_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='Enable this option to keep your imported carriers’ ID number as is. Otherwise, PrestaShop will ignore them and create auto-incremented ID numbers. If this option is enabled and there is a carrier in your database with this ID, then this carrier will not be inserted.' mod='ipcatalogexportimport'}"> 
                                        {l s='Keep ID numbers of inserted carriers' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_id" id="carrier_keep_id_yes" value="1" checked="checked" />
                                        <label for="carrier_keep_id_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_id" id="carrier_keep_id_no" value="0" />
                                        <label for="carrier_keep_id_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If a carrier exists with the imported carrier name, you can: 1) Ignore the imported row, 2) Create a new carrier with the existing name.' mod='ipcatalogexportimport'}">
                                        {l s='If a carrier exists with the carrier name you import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-3">
                                    <select name="name_exists"
                                            class="fixed-width-xxl"
                                            id="carrier_name_exists">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="convert" id="carrier_convert_yes" value="1" />
                                    <label for="carrier_convert_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="convert" id="carrier_convert_no" value="0" checked="checked" />
                                    <label for="carrier_convert_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="send_email" id="carrier_send_email_yes" value="1" />
                                    <label for="carrier_send_email_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="send_email" id="carrier_send_email_no" value="0" checked="checked" />
                                    <label for="carrier_send_email_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                            ...
                            {foreach from=$shops item=shop}
                                {if $shop.id_shop eq $context_shop}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="carrier_shops[{$shop.id_shop}]_yes" value="1" checked="checked" />
                                                <label for="carrier_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="carrier_shops[{$shop.id_shop}]_no" value="0" />
                                                <label for="carrier_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                                            </p>
                                ...
                                {else}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="carrier_shops[{$shop.id_shop}]_yes" value="1" />
                                                <label for="carrier_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="carrier_shops[{$shop.id_shop}]_no" value="0" checked="checked" />
                                                <label for="carrier_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                        ...
                        <div class="panel-footer">
                            <div class="text-right">
                                <button class="btn btn-default next" data-value="carrier">
                    ...
                    <div id="carrier_fields" class="tab-pane catalogEI_fields catalogEI_carrier_fields">
                        <div id="container-customer" class="panel">
                            ...
                            <div class="alert alert-info">
                                ...
                                <p><strong style="color:red">{l s='Important!' mod='ipcatalogexportimport'}</strong> {l s='If a carrier exists with the imported ID, it will be updated, otherwise a new carrier will be created. So, if you want to only create new carriers while there are existing ones with the imported IDs, you must ignore the ID column below. Note that "If a carrier exists with the imported carrier name" condition has priority!' mod='ipcatalogexportimport'}</p>
                            </div>
                            <div id="error_duplicate_type_carriers" class="alert alert-danger" style="display:none;">
                                {l s='Two columns cannot have the same value' mod='ipcatalogexportimport'}:
                                <strong></strong>
                            </div>
                            <div id="required_column_carriers" class="alert alert-danger" style="display:none;">
                                {l s='This column must be set:' mod='ipcatalogexportimport'} <span id="missing_column_carriers">&nbsp;</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-5">
                                    <label class="control-label" for="carrier_skip">
                                    ...
                                    &nbsp;
                                    <input class="fixed-width-md" type="text" name="skip" id="carrier_skip" value="1" />
                                </div>
                            ...
                            <div id="view_data_carriers" class="form-group catalogEI_view_data">
                                <div class="col-lg-12">
                                    {*{section name=nb_i start=0 loop=$nb_table step=1}
                                    {assign var=i value=$smarty.section.nb_i.index}
                                    {$data.$i}
                                    {/section}*}
                                    <div id="view_data_table_carriers" class="catalogEI_view_data_table">
                                        {$columns.carriers}
                                    </div>
                                    <div class="text-center paginate carriers">
                                        <button id="btn_left_carriers" type="button" class="btn btn-default go_left" disabled="disabled" data-entity="carriers">
                                            <i class="icon-angle-left"></i>
                                        </button>
                                        <button id="btn_carriers_page_1" type="button" class="btn btn-default activated btn_page" data-entity="carriers">1</button>
                                        <span class="dynamic_buttons">
                                            {if $paginator.carriers.nbTable > 7}
                                                <span id="btn_carriers_left_dots" class="hide">...</span>
                                                {for $foo=2 to $paginator.carriers.nbTable - 1}
                                                    <button id="btn_carriers_page_{$foo}" type="button" class="btn btn-default btn_hideable btn_page{if $foo > 5} hide{/if}" data-entity="carriers">{$foo}</button>
                                                {/for}
                                                <span id="btn_carriers_right_dots">...</span>
                                                <button id="btn_carriers_page_{$paginator.carriers.nbTable}" type="button" class="btn btn-default btn_page" data-entity="carriers">{$paginator.carriers.nbTable}</button>
                                            {else}
                                                {for $foo=2 to $paginator.carriers.nbTable}
                                                    <button id="btn_carriers_page_{$foo}" type="button" class="btn btn-default btn_page" data-entity="carriers">{$foo}</button>
                                                {/for}
                                            {/if}
                                        </span>
                                        <button id="btn_right_carriers" type="button" class="btn btn-default go_right"{if $paginator.carriers.nbTable == 1} disabled="disabled"{/if} data-entity="carriers">
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-default back" data-value="carrier">
                                <i class="process-icon-back"></i>{l s='Back' mod='ipcatalogexportimport'}
                            </button>
                            <button class="btn btn-default pull-right" type="submit" value="1" name="import_carriers" disabled>
