...
<div id="catalogEI-tab-content-Combination" class="catalogEI-tab-content" style="display: none;">
    <form id="import_form_combinations" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="combinations_import" novalidate="novalidate">
        <input type="hidden" name="entity" value="combinations" />
        ...
        <div id="catalogEI-combination" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                ...
                <div class="tab-content">
                    <div id="combination_configurations" class="tab-pane in active catalogEI_configurations">
                        ...
                        <div id="after_upload_success_alert_combinations" class="row after_upload_success_alert hide">
                        ...
                        <div id="after_upload_danger_alert_combinations" class="row after_upload_danger_alert hide">
                        ...
                        <div id="import_source_combinations" class="form-group import_source">
                            <br>
                        ...
                        <div id="import_type_combinations">
                            <br>
                            <div class="file_upload import_type">
                                <div id="file_uploader_combinations" class="form-group file_uploader">
                                    <label class="control-label col-lg-3 required">
                                        {l s='Select a file to import' mod='ipcatalogexportimport'}
                                    </label>
                                    <div class="col-lg-4">
                                        <input type="file" name="file" accept=".csv,.txt,.xls,.xlsx,.ods" data-entity="combinations" class="entity_file hide">
                                        <div class="dummyfile input-group">
                                            <input class="entity_file-name uploader_input" value="{l s='Choose file' mod='ipcatalogexportimport'}" type="text" name="combinations" readonly>
                                    ...
                                    <button type="button" class="btn btn-default show_upload_history" {if $files.combinations.data|count == 0}disabled{/if}>
                                    <span class="badge badge-info">{$files.combinations.data|count}</span> {l s='Choose from history' mod='ipcatalogexportimport'}
                                    </button>
                                    </div>*}
                                </div>
                            </div>
                            <div id="upload_history_combinations" class="panel upload_history import_type hide">
                                <div>
                                    <div class="panel-heading">
                                        {l s='History of uploaded files' mod='ipcatalogexportimport'}
                                        <span class="file_history_nb badge">{$files.combinations.data|count}</span>
                                        {*<button type="button" class="btn btn-link pull-right close_history_btn">
                                        <i class="icon-remove"></i>
                                        </button>*}
                                    </div>
                                    {*        <div class="panel-body">*}
                                    <table id="upload_history_table_combinations" class="table table-striped table-bordered upload_history_table" data-table="combinations">
                                        <thead>
                                            <tr>
                            ...
                            <div class="from_url import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-1">
                                        <button id="file_download_from_url_combinations" class="file_download_from_url_btn btn btn-default" data-entity="combinations">
                            ...
                            <div class="from_ftp import_type hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="fixed-width-xxl" id="ftp_type_combinations" name="ftp_type">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group fixed-width-xxl">
                                            <button id="file_download_from_ftp_combinations" class="file_download_from_ftp_btn btn btn-default pull-right" data-entity="combinations">
                                                <i class="process-icon-download"></i> {l s='Download' mod='ipcatalogexportimport'}
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="update_options hide">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If you don\'t update by ID, product data must be present, because the module searches for the combination based on both product and combination data.' mod='ipcatalogexportimport'}">
                                ...
                                <div class="col-lg-3">
                                    <select name="update_by"
                                            class="fixed-width-xxl"
                                            id="combination_update_by">
                                        <option value="id">{l s='Combination ID' mod='ipcatalogexportimport'}</option>
                                        <option value="reference">{l s='Combination Reference' mod='ipcatalogexportimport'}</option>
                                        <option value="attribute">{l s='Attribute Values' mod='ipcatalogexportimport'}</option>
                                    </select>
                                    <p class="help-block">
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_old_value" id="combination_keep_old_value_yes" value="1" checked="checked" />
                                        <label for="combination_keep_old_value_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_old_value" id="combination_keep_old_value_no" value="0" />
                                        <label for="combination_keep_old_value_no">{l s='No' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="insert_options">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip delete_entities" data-toggle="tooltip" title="" data-original-title="{l s='If enabled, all the existing combinations will be deleted before import.' mod='ipcatalogexportimport'}">
                                        {l s='Delete all existing combinations before import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="truncate" id="combination_truncate_yes" value="1" />
                                        <label for="combination_truncate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="truncate" id="combination_truncate_no" value="0" checked="checked" />
                                        <label for="combination_truncate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='Enable this option to keep your imported combinations’ ID number as is. Otherwise, PrestaShop will ignore them and create auto-incremented ID numbers. If this option is enabled and there is a combination in your database with this ID, then this combination will not be inserted.' mod='ipcatalogexportimport'}"> 
                                        {l s='Keep ID numbers of inserted combinations' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-9">
                                    <span class="switch prestashop-switch fixed-width-lg">
                                        <input type="radio" name="keep_id" id="combination_keep_id_yes" value="1" checked="checked" />
                                        <label for="combination_keep_id_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                        <input type="radio" name="keep_id" id="combination_keep_id_no" value="0" />
                                        <label for="combination_keep_id_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                        <a class="slide-button btn"></a>
                                    </span>
                                    <p class="help-block">
                                    </p>
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3">
                                    <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If a combination exists with the imported combination reference or attributes, you can: 1) Ignore the imported row, 2) Create a new combination with the existing reference or attributes, 3) Create a new combination if the reference does not exist and the attributes exist, 4) Create a new product if the attributes do not exist and the reference exists.' mod='ipcatalogexportimport'}">
                                        {l s='If a combination exists with the combination reference or attributes you import' mod='ipcatalogexportimport'}
                                    </span>
                                </label>
                                <div class="col-lg-3">
                                    <select name="name_exists"
                                            class="fixed-width-xxl"
                                            id="combination_name_exists">
                                        <option value="ignore">{l s='Do not insert' mod='ipcatalogexportimport'}</option>
                                        <option value="insert">{l s='Insert' mod='ipcatalogexportimport'}</option>
                                        <option value="insert_if_attribute_exists">{l s='Insert if the reference does not exist and the attributes exist' mod='ipcatalogexportimport'}</option>
                                        <option value="insert_if_reference_exists">{l s='Insert if the attributes do not exist and the reference exists' mod='ipcatalogexportimport'}</option>
                                    </select>
                                    <p class="help-block">
                                    </p>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="convert" id="combination_convert_yes" value="1" />
                                    <label for="combination_convert_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="convert" id="combination_convert_no" value="0" checked="checked" />
                                    <label for="combination_convert_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">
                                <span class="label-tooltip" data-toggle="tooltip" title="" data-original-title="{l s='If you enable this option, all type of images of combinations will be regenarated.' mod='ipcatalogexportimport'}"> 
                                    {l s='Regenerate thumbnails' mod='ipcatalogexportimport'}
                                </span>
                            </label>
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="regenerate" id="combination_regenerate_yes" value="1" checked="checked" />
                                    <label for="combination_regenerate_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="regenerate" id="combination_regenerate_no" value="0" />
                                    <label for="combination_regenerate_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="send_email" id="combination_send_email_yes" value="1" />
                                    <label for="combination_send_email_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="send_email" id="combination_send_email_no" value="0" checked="checked" />
                                    <label for="combination_send_email_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                                <p class="help-block">
                                </p>
                            ...
                            {foreach from=$shops item=shop}
                                {if $shop.id_shop eq $context_shop}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="combination_shops[{$shop.id_shop}]_yes" value="1" checked="checked" />
                                                <label for="combination_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="combination_shops[{$shop.id_shop}]_no" value="0" />
                                                <label for="combination_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                                            </p>
                                ...
                                {else}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <span class="switch prestashop-switch fixed-width-lg">
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="combination_shops[{$shop.id_shop}]_yes" value="1" />
                                                <label for="combination_shops[{$shop.id_shop}]_yes">{l s='Yes' mod='ipcatalogexportimport'}</label>
                                                <input type="radio" name="shops[{$shop.id_shop}]" id="combination_shops[{$shop.id_shop}]_no" value="0" checked="checked" />
                                                <label for="combination_shops[{$shop.id_shop}]_no">{l s='No' mod='ipcatalogexportimport'}</label>
                                                <a class="slide-button btn"></a>
                                            </span>
                                            <p class="help-block">
                        ...
                        <div class="panel-footer">
                            <div class="text-right">
                                <button class="btn btn-default next" data-value="combination">
                    ...
                    <div id="combination_fields" class="tab-pane catalogEI_fields catalogEI_combination_fields">
                        <div id="container-customer" class="panel">
                            ...
                            <div id="error_duplicate_type_combinations" class="alert alert-danger" style="display:none;">
                                {l s='Two columns cannot have the same value' mod='ipcatalogexportimport'}:
                                <strong></strong>
                            </div>
                            <div id="required_column_combinations" class="alert alert-danger" style="display:none;">
                                {l s='This column must be set:' mod='ipcatalogexportimport'} <span id="missing_column_combinations">&nbsp;</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-5">
                                    <label class="control-label" for="combination_skip">
                                    ...
                                    &nbsp;
                                    <input class="fixed-width-md" type="text" name="skip" id="combination_skip" value="1" />
                                </div>
                            ...
                            <div id="view_data_combinations" class="form-group catalogEI_view_data">
                                <div class="col-lg-12">
                                    {*{section name=nb_i start=0 loop=$nb_table step=1}
                                    {assign var=i value=$smarty.section.nb_i.index}
                                    {$data.$i}
                                    {/section}*}
                                    <div id="view_data_table_combinations" class="catalogEI_view_data_table">
                                        {$columns.combinations}
                                    </div>
                                    <div class="text-center paginate combinations">
                                        <button id="btn_left_combinations" type="button" class="btn btn-default go_left" disabled="disabled" data-entity="combinations">
                                            <i class="icon-angle-left"></i>
                                        </button>
                                        <button id="btn_combinations_page_1" type="button" class="btn btn-default activated btn_page" data-entity="combinations">1</button>
                                        <span class="dynamic_buttons">
                                            {if $paginator.combinations.nbTable > 7}
                                                <span id="btn_combinations_left_dots" class="hide">...</span>
                                                {for $foo=2 to $paginator.combinations.nbTable - 1}
                                                    <button id="btn_combinations_page_{$foo}" type="button" class="btn btn-default btn_hideable btn_page{if $foo > 5} hide{/if}" data-entity="combinations">{$foo}</button>
                                                {/for}
                                                <span id="btn_combinations_right_dots">...</span>
                                                <button id="btn_combinations_page_{$paginator.combinations.nbTable}" type="button" class="btn btn-default btn_page" data-entity="combinations">{$paginator.combinations.nbTable}</button>
                                            {else}
                                                {for $foo=2 to $paginator.combinations.nbTable}
                                                    <button id="btn_combinations_page_{$foo}" type="button" class="btn btn-default btn_page" data-entity="combinations">{$foo}</button>
                                                {/for}
                                            {/if}
                                        </span>
                                        <button id="btn_right_combinations" type="button" class="btn btn-default go_right"{if $paginator.combinations.nbTable == 1} disabled="disabled"{/if} data-entity="combinations">
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-default back" data-value="combination">
                                <i class="process-icon-back"></i>{l s='Back' mod='ipcatalogexportimport'}
                            </button>
                            <button class="btn btn-default pull-right" type="submit" value="1" name="import_combinations" disabled>
