...
<div id="catalogEI-tab-content-Store" class="catalogEI-tab-content" style="display: none;">
    <form id="store_export_form" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="store_export" novalidate="novalidate">
        <input type="hidden" name="export" value="store" />
        <div id="catalogEI-store" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#store_filters">
                ...
                <div class="tab-content">
                    <div id="store_configurations" class="tab-pane in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text"
                                       name="doc_name"
                                       id="store_doc_name"
                                       value="{l s='Stores' mod='ipcatalogexportimport'}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <select id="store_sort" name="sort" {*multiple*} class="fixed-width-xxl">
                                    <option value="store.id_store">{l s='ID' mod='ipcatalogexportimport'}</option>
                                    <option value="store.email">{l s='Email' mod='ipcatalogexportimport'}</option>
                                    <option value="store.firstname">{l s='First Name' mod='ipcatalogexportimport'}</option>
                                    <option value="store.lastname">{l s='Last Name' mod='ipcatalogexportimport'}</option>
                                    <option value="default_group_lang.name">{l s='Default Group Name' mod='ipcatalogexportimport'}</option>
                                    <option value="store.date_add">{l s='Registration Date' mod='ipcatalogexportimport'}</option>
                                </select>
                                <p class="help-block">
                                </p>
                            </div>
                            <div class="col-lg-5 col-lg-offset-1">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="sort_way" id="store_sort_asc" value="1" checked="checked" />
                                    <label for="store_sort_asc">{l s='ASC' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="sort_way" id="store_sort_desc" value="0" />
                                    <label for="store_sort_desc">{l s='DESC' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-xxl">
                                    ...
                                    <input id="store_speed" name="speed" type="range" min="1" max="7" step="1" value="4"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="store_filters" class="tab-pane catalogEI_filters">
                        <div class="alert alert-info alert-dismissible fade in">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        <div class="form-group date_collapser">
                            <label class="control-label col-lg-3">
                                {l s='Store Creation Date' mod='ipcatalogexportimport'}
                            </label>
                            <div class="col-lg-9">
                                <select id="store_date" name="date" class="fixed-width-xl">
                        ...
                        <hr>
                        <h4 class="filter">{l s='Filter By Store' mod='ipcatalogexportimport'}</h4>
                        <select id="ctrl-show-selected-stores" name="ctrl-show-selected-stores" class="show_selected pull-left">
                        ...
                        <button id="refresh_stores" class="btn btn-default refresh_button"><i class="icon-refresh"></i>
                            {l s='Reload table' mod='ipcatalogexportimport'}
                        </button>
                        <br>
                        <table id="stores_table" class="table table-striped table-bordered" style="width:100%;table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th></th>
                                    ...
                                    <th>{l s='ZIP/Postcode' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='State' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Country' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Phone' mod='ipcatalogexportimport'}</th>
                        ...
                        <div class="row">
                            <div class="scrollable col-md-6">
                                ...
                                <ul class="list-group item-list">
                                    <li class="list-group-item selected" data-value="store.id_store"><i class="icon-check-square-o"></i>{l s='Store ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.active"><i class="icon-check-square-o"></i>{l s='Active (0 = No, 1 = Yes)' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="{$store_table}.name"><i class="icon-check-square-o"></i>{l s='Name' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="{$store_table}.address1"><i class="icon-check-square-o"></i>{l s='Address' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="{$store_table}.address2"><i class="icon-check-square-o"></i>{l s='Address 2' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.city"><i class="icon-check-square-o"></i>{l s='City' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="store.id_country"><i class="icon-square-o"></i>{l s='Country ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    ...
                                    <li class="list-group-item additional" data-value="store.id_state"><i class="icon-square-o"></i>{l s='State ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    ...
                                    <li class="list-group-item selected" data-value="store.latitude"><i class="icon-check-square-o"></i>{l s='Latitude' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.longitude"><i class="icon-check-square-o"></i>{l s='Longitude' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.postcode"><i class="icon-check-square-o"></i>{l s='Zip/Postal Code' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.phone"><i class="icon-check-square-o"></i>{l s='Phone' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.fax"><i class="icon-check-square-o"></i>{l s='Fax' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.email"><i class="icon-check-square-o"></i>{l s='Email' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="{$store_table}.note"><i class="icon-check-square-o"></i>{l s='Note' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="{$store_table}.hours"><i class="icon-check-square-o"></i>{l s='Hours' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    ...
                                    <li class="list-group-item additional" data-value="store_image"><i class="icon-square-o"></i>{l s='Image' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="store.date_add"><i class="icon-check-square-o"></i>{l s='Creation Date' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="store.date_upd"><i class="icon-square-o"></i>{l s='Update Date' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button type="submit" value="1" name="store_export" class="btn btn-default">
                        <i class="process-icon-export"></i>{l s='Export Stores' mod='ipcatalogexportimport'}
                    </button>
                </div>
            </div>
        </div>
