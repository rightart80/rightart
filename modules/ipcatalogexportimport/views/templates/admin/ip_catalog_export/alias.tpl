...
<div id="catalogEI-tab-content-Alias" class="catalogEI-tab-content" style="display: none;">
    <form id="alias_export_form" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="alias_export" novalidate="novalidate">
        <input type="hidden" name="export" value="alias" />
        <div id="catalogEI-alias" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                ...
                <div class="tab-content">
                    <div id="alias_configurations" class="tab-pane in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text"
                                       name="doc_name"
                                       id="alias_doc_name"
                                       value="{l s='Aliases' mod='ipcatalogexportimport'}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <select id="alias_sort" name="sort" {*multiple*} class="fixed-width-xxl">
                                    <option value="alias.id_alias">{l s='ID' mod='ipcatalogexportimport'}</option>
                                    <option value="alias.email">{l s='Email' mod='ipcatalogexportimport'}</option>
                                    <option value="alias.firstname">{l s='First Name' mod='ipcatalogexportimport'}</option>
                                    <option value="alias.lastname">{l s='Last Name' mod='ipcatalogexportimport'}</option>
                                    <option value="default_group_lang.name">{l s='Default Group Name' mod='ipcatalogexportimport'}</option>
                                    <option value="alias.date_add">{l s='Registration Date' mod='ipcatalogexportimport'}</option>
                                </select>
                                <p class="help-block">
                                </p>
                            </div>
                            <div class="col-lg-5 col-lg-offset-1">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="sort_way" id="alias_sort_asc" value="1" checked="checked" />
                                    <label for="alias_sort_asc">{l s='ASC' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="sort_way" id="alias_sort_desc" value="0" />
                                    <label for="alias_sort_desc">{l s='DESC' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-xxl">
                                    ...
                                    <input id="alias_speed" name="speed" type="range" min="1" max="7" step="1" value="4"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="alias_filters" class="tab-pane catalogEI_filters">
                        ...
                        <hr>
                        <h4 class="filter">{l s='Filter By Alias' mod='ipcatalogexportimport'}</h4>
                        <select id="ctrl-show-selected-aliases" name="ctrl-show-selected-aliases" class="show_selected pull-left">
                        ...
                        <button id="refresh_aliases" class="btn btn-default refresh_button"><i class="icon-refresh"></i>
                            {l s='Reload table' mod='ipcatalogexportimport'}
                        </button>
                        <br>
                        <table id="aliases_table" class="table table-striped table-bordered" style="width:100%;table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>{l s='ID' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Alias' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Search' mod='ipcatalogexportimport'}</th>
                        ...
                        <div class="row">
                            <div class="scrollable col-md-6">
                                ...
                                <ul class="list-group item-list">
                                    <li class="list-group-item selected" data-value="alias.id_alias"><i class="icon-check-square-o"></i>{l s='Alias ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="alias.active"><i class="icon-check-square-o"></i>{l s='Active (0 = No, 1 = Yes)' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="alias.alias"><i class="icon-check-square-o"></i>{l s='Alias' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="alias.search"><i class="icon-check-square-o"></i>{l s='Search' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button type="submit" value="1" name="alias_export" class="btn btn-default">
                        <i class="process-icon-export"></i>{l s='Export Aliases' mod='ipcatalogexportimport'}
                    </button>
                </div>
            </div>
        </div>
