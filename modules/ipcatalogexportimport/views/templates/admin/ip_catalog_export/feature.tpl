...
<div id="catalogEI-tab-content-Feature" class="catalogEI-tab-content" style="display: none;">
    <form id="feature_export_form" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="feature_export" novalidate="novalidate">
        <input type="hidden" name="export" value="feature" />
        <div id="catalogEI-feature" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#feature_filters">
                ...
                <div class="tab-content">
                    <div id="feature_configurations" class="tab-pane in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text"
                                       name="doc_name"
                                       id="feature_doc_name"
                                       value="{l s='Features' mod='ipcatalogexportimport'}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <select id="feature_sort" name="sort" {*multiple*} class="fixed-width-xxl">
                                    <option value="feature.id_feature">{l s='Feature ID' mod='ipcatalogexportimport'}</option>
                                    <option value="feature_lang.name">{l s='Feature Name' mod='ipcatalogexportimport'}</option>
                                    <option value="feature.position">{l s='Feature Position' mod='ipcatalogexportimport'}</option>
                                    <option value="feature_value.id_feature_value">{l s='Feature Value ID' mod='ipcatalogexportimport'}</option>
                                    <option value="feature_value_lang.name">{l s='Feature Value' mod='ipcatalogexportimport'}</option>
                                </select>
                                <p class="help-block">
                                </p>
                            </div>
                            <div class="col-lg-5 col-lg-offset-1">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="sort_way" id="feature_sort_asc" value="1" checked="checked" />
                                    <label for="feature_sort_asc">{l s='ASC' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="sort_way" id="feature_sort_desc" value="0" />
                                    <label for="feature_sort_desc">{l s='DESC' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-xxl">
                                    ...
                                    <input id="feature_speed" name="speed" type="range" min="1" max="7" step="1" value="4"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="feature_filters" class="tab-pane catalogEI_filters">
                        <div class="alert alert-info alert-dismissible fade in">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        <select id="ctrl-show-selected-featuresForFeatures" name="ctrl-show-selected-featuresForFeatures" class="show_selected pull-left">
                        ...
                        <button id="refresh_featuresForFeatures" class="btn btn-default refresh_button"><i class="icon-refresh"></i>
                            {l s='Reload table' mod='ipcatalogexportimport'}
                        </button>
                        <br>
                        <table id="featuresForFeatures_table" class="table table-striped table-bordered" style="width:100%;table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th></th>
                        ...
                        <hr>
                        <h4 class="filter">{l s='Filter By Feature Value' mod='ipcatalogexportimport'}</h4>
                        <select id="ctrl-show-selected-featureValues" name="ctrl-show-selected-featureValues" class="show_selected pull-left">
                            <option value="all" selected>{l s='Show all' mod='ipcatalogexportimport'}</option>
                            <option value="selected">{l s='Show selected' mod='ipcatalogexportimport'}</option>
                            <option value="not-selected">{l s='Show deselected' mod='ipcatalogexportimport'}</option>
                        </select>
                        <button id="refresh_featureValues" class="btn btn-default refresh_button"><i class="icon-refresh"></i>
                            {l s='Reload table' mod='ipcatalogexportimport'}
                        </button>
                        <br>
                        <table id="featureValues_table" class="table table-striped table-bordered" style="width:100%;table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>{l s='ID' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Value' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Is Custom' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Feature ID' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Feature Name' mod='ipcatalogexportimport'}</th>
                                </tr>
                            </thead>
                        </table>
                        <br>
                        ...
                        <div class="row">
                            <div class="scrollable col-md-6">
                                ...
                                <ul class="list-group item-list">
                                    <li class="list-group-item selected" data-value="feature.id_feature"><i class="icon-check-square-o"></i>{l s='Feature ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="feature_lang.name"><i class="icon-check-square-o"></i>{l s='Feature Name' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="feature.position"><i class="icon-check-square-o"></i>{l s='Feature Position' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="feature_value.id_feature_value"><i class="icon-check-square-o"></i>{l s='Feature Value ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="feature_value_lang.value"><i class="icon-check-square-o"></i>{l s='Feature Value' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="feature_value.custom"><i class="icon-check-square-o"></i>{l s='Feature Value Is Custom' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button type="submit" value="1" name="feature_export" class="btn btn-default">
                        <i class="process-icon-export"></i>{l s='Export Features' mod='ipcatalogexportimport'}
                    </button>
                </div>
            </div>
        </div>
