...
<div id="catalogEI-tab-content-Warehouse" class="catalogEI-tab-content" style="display: none;">
    <form id="warehouse_export_form" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="warehouse_export" novalidate="novalidate">
        <input type="hidden" name="export" value="warehouse" />
        <div id="catalogEI-warehouse" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#warehouse_filters">
                ...
                <div class="tab-content">
                    <div id="warehouse_configurations" class="tab-pane in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text"
                                       name="doc_name"
                                       id="warehouse_doc_name"
                                       value="{l s='Warehouses' mod='ipcatalogexportimport'}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <select id="warehouse_sort" name="sort" {*multiple*} class="fixed-width-xxl">
                                    <option value="warehouse.id_warehouse">{l s='ID' mod='ipcatalogexportimport'}</option>
                                    <option value="warehouse.reference">{l s='Reference' mod='ipcatalogexportimport'}</option>
                                    <option value="warehouse.name">{l s='Name' mod='ipcatalogexportimport'}</option>
                                    <option value="warehouse.management_type">{l s='Management type' mod='ipcatalogexportimport'}</option>
                                </select>
                                <p class="help-block">
                                </p>
                            </div>
                            <div class="col-lg-5 col-lg-offset-1">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="sort_way" id="warehouse_sort_asc" value="1" checked="checked" />
                                    <label for="warehouse_sort_asc">{l s='ASC' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="sort_way" id="warehouse_sort_desc" value="0" />
                                    <label for="warehouse_sort_desc">{l s='DESC' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-xxl">
                                    ...
                                    <input id="warehouse_speed" name="speed" type="range" min="1" max="7" step="1" value="4"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="warehouse_filters" class="tab-pane catalogEI_filters">
                        <div class="alert alert-info alert-dismissible fade in">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        <hr>
                        <h4 class="filter">{l s='Filter By Warehouse' mod='ipcatalogexportimport'}</h4>
                        <select id="ctrl-show-selected-warehouses" name="ctrl-show-selected-warehouses" class="show_selected pull-left">
                        ...
                        <button id="refresh_warehouses" class="btn btn-default refresh_button"><i class="icon-refresh"></i>
                            {l s='Reload table' mod='ipcatalogexportimport'}
                        </button>
                        <br>
                        <table id="warehouses_table" class="table table-striped table-bordered" style="width:100%;table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th></th>
                                    ...
                                    <th>{l s='Management Type' mod='ipcatalogexportimport'}</th>
                                    <th>{l s='Currency ISO' mod='ipcatalogexportimport'}</th>
                        ...
                        <div class="row">
                            <div class="scrollable col-md-6">
                                ...
                                <ul class="list-group item-list">
                                    <li class="list-group-item selected" data-value="warehouse.id_warehouse"><i class="icon-check-square-o"></i>{l s='Warehouse ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="warehouse.reference"><i class="icon-check-square-o"></i>{l s='Reference' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="warehouse.name"><i class="icon-check-square-o"></i>{l s='Name' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="warehouse.management_type" title="{l s='WA = Weighted Average, FIFO = First in, first out, LIFO = Last in, first out' mod='ipcatalogexportimport'}"><i class="icon-check-square-o"></i>{l s='Management Type' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="warehouse.id_currency"><i class="icon-square-o"></i>{l s='Currency ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="currency.iso_code"><i class="icon-check-square-o"></i>{l s='Currency ISO' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    ...
                                    <li class="list-group-item additional" data-value="address.id_state"><i class="icon-square-o"></i>{l s='State ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    ...
                                    <li class="list-group-item selected" data-value="employee.email"><i class="icon-check-square-o"></i>{l s='Manager Email' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="employee.firstname"><i class="icon-square-o"></i>{l s='Manager First Name' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="employee.lastname"><i class="icon-square-o"></i>{l s='Manager Last Name' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="carrier.ids"><i class="icon-square-o"></i>{l s='Carrier IDs (x,y,z...)' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="carrier.names"><i class="icon-check-square-o"></i>{l s='Carrier Names (x,y,z...)' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button type="submit" value="1" name="warehouse_export" class="btn btn-default">
                        <i class="process-icon-export"></i>{l s='Export Warehouses' mod='ipcatalogexportimport'}
                    </button>
                </div>
            </div>
        </div>
