...
<div id="catalogEI-tab-content-Supplier" class="catalogEI-tab-content" style="display: none;">
    <form id="supplier_export_form" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="supplier_export" novalidate="novalidate">
        ...
        <div id="catalogEI-supplier" class="panel catalogEI-tab">
            ...
            <div class="form-wrapper">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#supplier_filters">
                ...
                <div class="tab-content">
                    <div id="supplier_configurations" class="tab-pane in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text"
                                       name="doc_name"
                                       id="supplier_doc_name"
                                       value="{l s='Suppliers' mod='ipcatalogexportimport'}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <select id="supplier_sort" name="sort" {*multiple*} class="fixed-width-xxl">
                                    <option value="supplier.id_supplier">{l s='ID' mod='ipcatalogexportimport'}</option>
                                    <option value="supplier.name">{l s='Name' mod='ipcatalogexportimport'}</option>
                                    <option value="supplier.date_add">{l s='Creation Date' mod='ipcatalogexportimport'}</option>
                                </select>
                                <p class="help-block">
                                </p>
                            </div>
                            <div class="col-lg-5 col-lg-offset-1">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="sort_way" id="supplier_sort_asc" value="1" checked="checked" />
                                    <label for="supplier_sort_asc">{l s='ASC' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="sort_way" id="supplier_sort_desc" value="0" />
                                    <label for="supplier_sort_desc">{l s='DESC' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-xxl">
                                    ...
                                    <input id="supplier_speed" name="speed" type="range" min="1" max="7" step="1" value="4"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="supplier_filters" class="tab-pane catalogEI_filters">
                        <div class="alert alert-info alert-dismissible fade in">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        <div class="form-group date_collapser">
                            <label class="control-label col-lg-3">
                                {l s='Supplier Creation Date' mod='ipcatalogexportimport'}
                            </label>
                            <div class="col-lg-9">
                                <select id="supplier_date" name="date" class="fixed-width-xl">
                        ...
                        <select id="ctrl-show-selected-suppliers2" name="ctrl-show-selected-suppliers2" class="show_selected pull-left">
                        ...
                        <button id="refresh_suppliers2" class="btn btn-default refresh_button"><i class="icon-refresh"></i>
                            {l s='Reload table' mod='ipcatalogexportimport'}
                        </button>
                        <br>
                        <table id="suppliers2_table" class="table table-striped table-bordered" style="width:100%;table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th></th>
                        ...
                        <div class="row">
                            <div class="scrollable col-md-6">
                                ...
                                <ul class="list-group item-list">
                                    <li class="list-group-item selected" data-value="supplier.id_supplier"><i class="icon-check-square-o"></i>{l s='Supplier ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="supplier.active"><i class="icon-check-square-o"></i>{l s='Active (0 = No, 1 = Yes)' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="supplier.name"><i class="icon-check-square-o"></i>{l s='Name' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="supplier_link"><i class="icon-square-o"></i>{l s='Link' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="supplier_lang.description"><i class="icon-check-square-o"></i>{l s='Description' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="supplier_lang.meta_title"><i class="icon-check-square-o"></i>{l s='Meta Title' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="supplier_lang.meta_keywords"><i class="icon-check-square-o"></i>{l s='Meta Keywords' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="supplier_lang.meta_description"><i class="icon-check-square-o"></i>{l s='Meta Description' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="supplier_image"><i class="icon-square-o"></i>{l s='Image' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    ...
                                    <li class="list-group-item selected" data-value="supplier.date_add" title="{l s='Supplier creation date' mod='ipcatalogexportimport'}"><i class="icon-check-square-o"></i>{l s='Creation Date' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="supplier.date_upd" title="{l s='Supplier update date' mod='ipcatalogexportimport'}"><i class="icon-square-o"></i>{l s='Update Date' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button type="submit" value="1" name="supplier_export" class="btn btn-default">
                        <i class="process-icon-export"></i>{l s='Export Suppliers' mod='ipcatalogexportimport'}
                    </button>
                </div>
            </div>
        </div>
