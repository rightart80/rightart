...
<div id="catalogEI-tab-content-Brand" class="catalogEI-tab-content" style="display: none;">
    <form id="brand_export_form" class="form-horizontal catalogEI_form" action="{$ajax_url}" method="post" enctype="multipart/form-data" name="brand_export" novalidate="novalidate">
        <input type="hidden" name="export" value="brand" />
        <div id="catalogEI-brand" class="panel catalogEI-tab">
            <h3 class="tab"><i class="icon-bank"></i> {l s='Manufacturers' mod='ipcatalogexportimport'}</h3>
            <div class="form-wrapper">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#brand_configurations">
                            <i class="icon-wrench"></i>
                            {l s='Configurations' mod='ipcatalogexportimport'}</a></li>
                    <li><a data-toggle="tab" href="#brand_filters">
                ...
                <div class="tab-content">
                    <div id="brand_configurations" class="tab-pane in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text"
                                       name="doc_name"
                                       id="brand_doc_name"
                                       value="{l s='Brands' mod='ipcatalogexportimport'}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <select id="brand_sort" name="sort" {*multiple*} class="fixed-width-xxl">
                                    <option value="manufacturer.id_manufacturer">{l s='ID' mod='ipcatalogexportimport'}</option>
                                    <option value="manufacturer.name">{l s='Name' mod='ipcatalogexportimport'}</option>
                                    <option value="manufacturer.date_add">{l s='Creation Date' mod='ipcatalogexportimport'}</option>
                                </select>
                                <p class="help-block">
                                </p>
                            </div>
                            <div class="col-lg-5 col-lg-offset-1">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    <input type="radio" name="sort_way" id="brand_sort_asc" value="1" checked="checked" />
                                    <label for="brand_sort_asc">{l s='ASC' mod='ipcatalogexportimport'}</label>
                                    <input type="radio" name="sort_way" id="brand_sort_desc" value="0" />
                                    <label for="brand_sort_desc">{l s='DESC' mod='ipcatalogexportimport'}</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-xxl">
                                    ...
                                    <input id="brand_speed" name="speed" type="range" min="1" max="7" step="1" value="4"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="brand_filters" class="tab-pane catalogEI_filters">
                        <div class="alert alert-info alert-dismissible fade in">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        <div class="form-group date_collapser">
                            <label class="control-label col-lg-3">
                                {l s='Brand Creation Date' mod='ipcatalogexportimport'}
                            </label>
                            <div class="col-lg-9">
                                <select id="brand_date" name="date" class="fixed-width-xl">
                        ...
                        <select id="ctrl-show-selected-brands" name="ctrl-show-selected-brands" class="show_selected pull-left">
                        ...
                        <button id="refresh_brands" class="btn btn-default refresh_button"><i class="icon-refresh"></i>
                            {l s='Reload table' mod='ipcatalogexportimport'}
                        </button>
                        <br>
                        <table id="brands_table" class="table table-striped table-bordered" style="width:100%;table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th></th>
                        ...
                        <div class="row">
                            <div class="scrollable col-md-6">
                                ...
                                <ul class="list-group item-list">
                                    <li class="list-group-item selected" data-value="manufacturer.id_manufacturer"><i class="icon-check-square-o"></i>{l s='Brand ID' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="manufacturer.active"><i class="icon-check-square-o"></i>{l s='Active (0 = No, 1 = Yes)' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="manufacturer.name"><i class="icon-check-square-o"></i>{l s='Name' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="brand_link"><i class="icon-square-o"></i>{l s='Link' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="manufacturer_lang.description"><i class="icon-check-square-o"></i>{l s='Description' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="manufacturer_lang.short_description"><i class="icon-check-square-o"></i>{l s='Short Description' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="manufacturer_lang.meta_title"><i class="icon-check-square-o"></i>{l s='Meta Title' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="manufacturer_lang.meta_keywords"><i class="icon-check-square-o"></i>{l s='Meta Keywords' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item selected" data-value="manufacturer_lang.meta_description"><i class="icon-check-square-o"></i>{l s='Meta Description' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="brand_image"><i class="icon-square-o"></i>{l s='Image' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    ...
                                    <li class="list-group-item selected" data-value="manufacturer.date_add" title="{l s='Brand creation date' mod='ipcatalogexportimport'}"><i class="icon-check-square-o"></i>{l s='Creation Date' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                    <li class="list-group-item additional" data-value="manufacturer.date_upd" title="{l s='Brand update date' mod='ipcatalogexportimport'}"><i class="icon-square-o"></i>{l s='Update date' mod='ipcatalogexportimport'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button type="submit" value="1" name="brand_export" class="btn btn-default">
                        <i class="process-icon-export"></i>{l s='Export Brands' mod='ipcatalogexportimport'}
                    </button>
                </div>
            </div>
        </div>
