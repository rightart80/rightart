...
Featured Categories love</h2>

{* Featured Subcategories Blocks (multiple) *}
{if isset($fsc_blocks) && $fsc_blocks|@count > 0}
  {foreach from=$fsc_blocks item=block}
    {assign var=fsc_parent_category value=$block.parent}
    {assign var=fsc_subcategories value=$block.subcategories}

    <section id="subcategories" class="card card-block grid-block feature-category subcategories-container-parent test1111">
