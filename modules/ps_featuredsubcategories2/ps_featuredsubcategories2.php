...
class Ps_FeaturedSubcategories2 extends Module
{
    // Separate config key so this module has its own blocks
    const CFG_BLOCKS = 'PS_FSC2_BLOCKS';
    ...
    public function __construct()
    {
        ...
        $this->name = 'ps_featuredsubcategories2';
        ...
        // Visible name in BO
        $this->displayName = $this->l('Featured subcategories 2');
        $this->description = $this->l('Displays selected categories (or subcategories) in configurable blocks (second instance).');
        $this->ps_versions_compliancy = array('min' => '1.7.0.0', 'max' => _PS_VERSION_);

        // Point to tpl in this module's folder
        $this->templateFile = 'module:ps_featuredsubcategories2/views/templates/hook/ps_featuredsubcategories.tpl';
    }
    ...
    protected function processSaveBlock()
    {
        ...
        // Validate category list (can be ANY category IDs)
        $subcat_ids = array();
    ...
    protected function renderForm()
    {
        ...
        $fieldsForm = array(
            'form' => array(
                'legend' => array(
                    'title' => $this->l('Featured categories settings (Module 2)'),
                    'icon'  => 'icon-cogs',
                ),
                'input' => array(
                    array(
    ...
    protected function renderBlocksTable(array $blocks)
    {
        $html = '<div class="panel">
            <div class="panel-heading">' . $this->l('Existing blocks (Module 2)') . '</div>';
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        foreach ($blocksData as $b) {
            ...
            if ($selected !== '') {
                // EXPLICIT CATEGORY IDs – can be ANY categories in the shop
                ...
                // No explicit IDs => fallback to direct children of the title category (old behavior)
